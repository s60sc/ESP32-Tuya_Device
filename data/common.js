// s60sc 2021
  ...
  function sendUpdates(doAction) {    
    ...
    $('input').each(function () {
      ...
      if ($(this).attr('type') == "time") jarray[$(this).attr('id')] = $(this).val().trim();
      if ($(this).attr('type') == "number") jarray[$(this).attr('id')] = $(this).val().trim();
  ...
  $(document).on('click','button', function(){
    ...
    if (this.classList.contains('web-action')) window.location.href='/web?'+this.value;  
  });
